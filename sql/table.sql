...
create table Zhengh_StudentScore18(
    ...
    constraint Zhengh_FK_StudentScore_Student18 foreign key(zh_Sno18)
    references Zhengh_Student18(zh_Sno18),
    constraint Zhengh_FK_StudentScore_Course18 foreign key (zh_Cno18),
    references Zhengh_Course18(zh_Cno18)
)
